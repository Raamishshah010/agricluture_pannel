...
export default function Articles() {
    ...
    const handleSubmit = async () => {
        ...
        if (editingItem) {
            ...
            const res = await service.updateArticle(editingItem.id, fd);
            setList(prev => prev.map(article =>
            ...
            fd.append('file', formData.image);
            const res = await service.addArticle(fd);
    ...
    const handleDelete = async (id) => {
        if (window.confirm('Are you sure you want to delete this?')) {
            ...
            setList(prev => prev.filter(article => article.id !== id));
        }
    };
       ...
       <div className="min-h-screen bg-gray-50 p-0 md:p-8">
            <div className="max-w-7xl mx-auto">
                <div className="mb-8 flex flex-col-reverse md:flex-row mt-2 justify-between items-center">
                    <div>
                        <h1 className="text-xl md:text-3xl font-bold text-gray-900">Articles</h1>
                        <p className="text-gray-600 mt-1">Manage articles</p>
                    </div>
                    <button
                ...
                <div className="bg-white rounded-lg shadow overflow-hidden">
                    ...
                    {list.length === 0 && (
                        <div className="text-center py-12 text-gray-500">
                            No data found. Add your first article to get started.
                        </div>
                    )}
                </div>
