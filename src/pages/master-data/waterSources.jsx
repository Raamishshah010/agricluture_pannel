...
export default function WaterSources() {
    ...
    const handleDelete = async (id) => {
        if (window.confirm(t('waterSources.confirmDelete'))) {
            try {
       ...
       <div className="min-h-screen bg-gray-50 p-0 md:p-8">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="mt-4 text-sm text-gray-600">
                    {t('waterSources.totalItems')}: {list.length}
                </div>
            </div>
                    ...
                    <div className="bg-white rounded-lg shadow-xl max-w-md w-full">
                        <div className="flex justify-between items-center px-6 py-4 border-b border-gray-200">
                            <h2 className="text-xl font-semibold text-gray-900">
                                {editingItem ? t('waterSources.editItem') : t('waterSources.addNewItem')}
                            </h2>
                            <button
                                onClick={closeModal}
                            ...
                            <div className="space-y-4">
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 mb-1">
                                        {t('waterSources.nameEnglishLabel')}
                                    </label>
                                    <input
                                        type="text"
                                        name="name"
                                        ...
                                        placeholder={t('waterSources.nameEnglishPlaceholder')}
                                    />
                                </div>
                            </div>
                            <div className="space-y-4">
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 mb-1">
                                        {t('waterSources.nameArabicLabel')}
                                    </label>
                                    <input
                                        type="text"
                                        name="nameInArrabic"
                                        ...
                                        onChange={handleInputChange}
                                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"
                                        placeholder={t('waterSources.nameArabicPlaceholder')}
                                    />
                                </div>
                            </div>
