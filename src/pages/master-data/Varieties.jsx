...
export default function Varieties() {
    ...
    const openEditModal = async (variety) => {
        ...
        setFormData({
            name: variety.name,
            nameInArabic: variety.nameInArabic || '',
    ...
    const handleSubmit = async () => {
        if (!formData.name.trim() || !formData.nameInArabic.trim()) {
            toast.error(t('varieties.validation.allFieldsRequired'));
            return;
        }
                            ...
                            <table className="w-full">
                                <thead className="bg-gray-100 border-b border-gray-200">
                                    <tr>
                                        ...
                                        <th className="px-6 py-4 text-left text-sm font-semibold text-gray-700">{t('varieties.table.headers.nameArabic') || 'Arabic Name'}</th>
                                ...
                                <tbody className="divide-y divide-gray-200">
                                    {varities.map((variety) => (
                                        <tr key={variety.id} className="hover:bg-gray-50 transition-colors">
                                            ...
                                            <td className="px-6 py-4 text-sm text-gray-700">{variety.nameInArabic || '—'}</td>
                    ...
                    <div className="bg-white rounded-lg shadow-xl max-w-md w-full">
                        ...
                        <div className="px-6 py-4">
                            <div className="space-y-4">
                                ...
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 mb-1">
                                        {t('varieties.modal.labels.nameArabic') || 'Arabic Name'} *
                                    </label>
                                    <input
                                        type="text"
                                        name="nameInArabic"
                                        ...
                                        onChange={handleInputChange}
                                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"
                                        placeholder={t('varieties.modal.nameArabicPlaceholder') || 'مثال: فلّة'}
                                    />
                                </div>
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 mb-1">
