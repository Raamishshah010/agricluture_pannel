...
export default function VegetableType() {
    ...
    const handleDelete = async (id) => {
        if (window.confirm(t('vegetableTypes.confirmDelete'))) {
            try {
                    ...
                    <div className="bg-white rounded-lg shadow-xl max-w-md w-full">
                        <div className="flex justify-between items-center px-6 py-4 border-b border-gray-200">
                            <h2 className="text-lg font-semibold text-gray-900">
                                {editingEmirate ? t('vegetableTypes.modal.editItem') : t('vegetableTypes.modal.addNewItem')}
                            </h2>
                            <button
                                onClick={closeModal}
                            ...
                            <div className="space-y-4">
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 mb-2">
                                        {t('vegetableTypes.modal.labels.nameEnglish')} <span className="text-red-500">*</span>
                                    </label>
                                    <input
                                        type="text"
                                        name="name"
                                        ...
                                        placeholder={t('vegetableTypes.modal.placeholders.nameEnglish')}
                                    />
                                </div>
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 mb-2">
                                        {t('vegetableTypes.modal.labels.nameArabic')} <span className="text-red-500">*</span>
                                    </label>
                                    <input
                                        type="text"
                                        name="nameInArrabic"
                                        ...
                                        onChange={handleInputChange}
                                        className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent text-sm"
                                        placeholder={t('vegetableTypes.modal.placeholders.nameArabic')}
                                    />
                                </div>
                            </div>
                            ...
                            <div className="flex justify-end gap-3 mt-6 pt-5 border-t border-gray-200">
                                ...
                                >
                                    {loading ? (
                                        ...
                                        <>
                                            {editingEmirate ? t('vegetableTypes.modal.update') : t('vegetableTypes.modal.addItem')}
                                        </>
                                    )}
                                </button>
                            </div>
