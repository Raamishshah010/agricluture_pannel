...
const downloadPDF = () => {
    ...
    // 3. Reverse only if Arabic
    if (isArabic) {
        tableHeaders = [...tableHeaders].reverse();
        tableData = tableData.map(row => [...row].reverse());
    }
    ...
    autoTable(doc, {
        ...
        body: tableData,
        startY: 30,
        // 'wrap' ki jagah 'auto' ya fixed width use karein taake table poora phele
        tableWidth: 'auto', 
        ...
        // Har column ko force karein ke wo right-align ho
        columnStyles: {
        ...
        <div className="max-w-7xl mx-auto px-6 py-6">
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
            <div>
              ...
              <p className="text-sm text-gray-500">{t("coders.subtitle")}</p>
            </div>
